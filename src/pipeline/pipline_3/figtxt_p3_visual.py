...
class ImageInfoExtractor:
  PROMPT_VISUAL = """Act like a professional visual content analyst with over 20 years of experience in image data analysis. You specialize in interpreting complex charts, images, and graphics, ensuring that every relevant visual detail is accurately captured and thoroughly described.
>>> Task: 
...
def main(model, data, output, fig_root, tp):
    ...
    image_info_extractor = ImageInfoExtractor(model=model, tp=tp)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="OpenGVLab/InternVL2-Llama3-76B", type=str)
    parser.add_argument("--data", default="/root/benchmark/data/2024_s1.jsonl", type=str)
    parser.add_argument("--output", default="/root/benchmark/data/2024_s1_visal.jsonl", type=str)
